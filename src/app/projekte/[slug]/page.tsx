...
import { ChevronRight, Check, MapPin, Hammer, Trees, Calendar } from "lucide-react";
...
export default async function ProjectPage({
  ...
  // Other projects (same city OR same service), but not this one
        ...
        <div className="container-prose grid lg:grid-cols-12 gap-10 lg:gap-16 items-start">
          ...
          <Reveal className="lg:col-span-4 lg:sticky lg:top-28">
            <div className="rounded-2xl border border-border bg-card p-6 sm:p-7 space-y-5">
              ...
              {material && (
                <MetaRow Icon={Trees} label="Hauptmaterial" value={material.name} />
              )}
              {project.year && (
