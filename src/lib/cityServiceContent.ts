...
export function buildCityServiceCopy(city: City, combo: CityService): string[] {
  ...
  const TEMPLATES: Record<string, string[]> = {
    ...
    treppenbau: [
      `{Eine Treppe für|Holztreppen für|Treppen nach Maß für} ${c} {sind unsere Königsdisziplin|bauen wir als Skulptur|fertigen wir Stufe für Stufe} – {freitragend, gewendelt oder als Faltwerk|in Eiche, Buche oder Nuss|mit Geländer aus Holz}. {Als Treppenbauer für|Als Schreiner für Treppen in|Als Treppenbau-Betrieb für} ${c} {planen wir auch die Statik|berechnen wir jedes Geländer|arbeiten wir aus Edingen-Neckarhausen}.`,
      `{Ob Neubau oder Sanierung|Für Neubau und Altbau|Ob neue Treppe oder Aufarbeitung} – {wir passen jede Stufe einzeln ein|wir bauen mit minimalem Eingriff|wir fertigen jede Stufe nach Maß}. {Wir kommen zum Aufmaß nach|Wir planen vor Ort in|Wir liefern und montieren in} ${c}, {inklusive Statikplanung|mit verbindlichem Festpreis nach Aufmaß|persönlich durch den Meister}.`,
    ],
    tueren: [
