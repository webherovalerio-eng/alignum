  ...
  const steps = [
    {
      ...
      body: `Wir kommen kostenlos zu Ihnen nach ${city.name}, hören zu, vermessen den Raum bis auf den Millimeter und besprechen Ideen, Material und Budget. Als Tischlermeister und Inhaber – persönlich.`,
      tag: "Vor Ort",
    },
    {
      n: "02",
      ...
      body: `Aus Ihren Ideen entstehen erst Handskizzen mit Bleistift, auf Wunsch präzise CAD-Pläne mit Renderings. Erst wenn alles passt, geht es in die Fertigung.`,
      tag: "Entwurf",
    },
    {
      n: "03",
      ...
      body: `Gebaut wird in ${SITE.address.street}, ${SITE.address.zip} ${SITE.address.city}. Massivholz, traditionelles Schreiner­handwerk – massivholzgerechte Bauweise, bei der das Handwerk im Vordergrund steht.`,
    ...
    },
    {
      ...
      body: `Eigenes Montage-Team kommt zu Ihnen nach ${city.name}. Wir liefern, montieren, justieren und säubern – Sie sehen Ihr Möbel zum ersten Mal in seinem neuen Zuhause.`,
      tag: "Bei Ihnen",
    },
  ];
